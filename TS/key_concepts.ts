...
// ⁡⁢⁣⁢TYPE SCRIPT⁡
{
	...
	{
		// ⁡⁣⁢⁢1. В ЧЕМ РАЗНИЦА МЕЖДУ TYPESCRIPT И JAVASCRIPT?⁡
		{
		...
		// ⁡⁣⁢⁢2. ЧТО ТАКОЕ "УТИНАЯ ТИПИЗАЦИЯ" В TYPESCRIPT?⁡
		{
		...
		// ⁡⁣⁢⁢3. КАК РАБОТАЮТ ДЖЕНЕРИКИ В TYPESCRIPT?⁡
		{
		...
		// ⁡⁣⁢⁢4. ЧТО ТАКОЕ "TYPE ASSERTION" И КАК ЕГО ИСПОЛЬЗОВАТЬ?⁡
		{
		...
		// ⁡⁣⁢⁢5. КАК TYPESCRIPT ОБРАБАТЫВАЕТ НЕОБЯЗАТЕЛЬНЫЕ И NULLABLE ПАРАМЕТРЫ?⁡
		{
		...
		// ⁡⁣⁢⁢6. ЧТО ТАКОЕ "ДЕКОРАТОРЫ" И КАК ОНИ РАБОТАЮТ?⁡
		{
		...
		// ⁡⁣⁢⁢7. КАК TYPESCRIPT ПОДДЕРЖИВАЕТ ПЕРЕГРУЗКУ ФУНКЦИЙ?⁡
		{
		...
		// ⁡⁣⁢⁢8. ЧТО ТАКОЕ "УТИЛИТАРНЫЕ ТИПЫ" (UTILITY TYPES)?⁡
		{
		...
		// ⁡⁣⁢⁢9. КАК TYPESCRIPT ОБРАБАТЫВАЕТ МОДУЛИ?⁡
		{
		...
		// ⁡⁣⁢⁢10. ЧТО ТАКОЕ "NEVER" ТИП И КОГДА ОН ИСПОЛЬЗУЕТСЯ?⁡
		{
		...
		// ⁡⁣⁢⁢11. КАК ИСПОЛЬЗОВАТЬ МИКСИНЫ В TYPESCRIPT?⁡
		{
		...
		// ⁡⁣⁢⁢12. КАК TYPESCRIPT РАБОТАЕТ С REACT?⁡
		{
		...
		// ⁡⁣⁢⁢13. ЧТО ТАКОЕ "УСЛОВНЫЕ ТИПЫ" (CONDITIONAL TYPES)?⁡
		{
		...
		// ⁡⁣⁢⁢14. КАК ИСПОЛЬЗОВАТЬ КЛЮЧЕВЫЕ СЛОВА "KEYOF" И "IN"?⁡
		{
		...
		// ⁡⁣⁢⁢15. ЧТО ТАКОЕ "ИНТЕРСЕКШН ТИПЫ" (INTERSECTION TYPES)?⁡
		{
	...
	// ⁡⁢⁣⁣3. КЛАССЫ И МОДИФИКАТОРЫ ДОСТУПА (PUBLIC, PRIVATE, PROTECTED):⁡
