...
//! СОБЫТИЯ МЫШИ:
{
	//* click – происходит, когда кликнули на элемент левой кнопкой мыши (на устройствах с сенсорными экранами оно происходит при касании). Чаще всего используется; срабатывает после mousedown + mouseup
	//* dblclick — Двойной клик. Может конфликтовать с click; требует осторожности
	//* mousedown – когда нажали кнопку мыши на элементе. Нажатие кнопки мыши. Срабатывает в момент нажатия, до click
	//* mouseup – отпустили кнопку мыши на элементе. Завершает действие, часто используется для drag-and-drop
	//* mousemove – при движении мыши. Срабатывает очень часто — может вызывать лаги без throttle/debounce
	//* mouseenter — Курсор вошёл на элемент. Не всплывает; аналог mouseover, но без bubbling
	//* mouseleave — Курсор покинул элемент. Не всплывает; удобен для скрытия тултипов/меню
	//* mouseover – когда мышь наводится на элемент. Всплывает; срабатывает также на дочерних элементах
	//* mouseout  - покидает элемент. Всплывает; может срабатывать «лишний раз» из-за детей
	//* contextmenu – происходит, когда кликнули на элемент правой кнопкой мыши. Можно отменить через event.preventDefault()
}
//! СОБЫТИЯ УКАЗАТЕЛЯ:
{
