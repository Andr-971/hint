...
// ⁡⁣⁡⁣⁣⁡⁢⁣⁣ОБЪЕКТЫ И МАССИВЫ⁡
{
	...
	// ⁡⁣⁣⁢Функция преобразования массива объектов в массив значений⁡
	{
		// ⚡ ⁡⁢⁣⁣Универсальная функция с настраиваемыми ключами⁡
		{
			/**
			 * @param {Array} data - входной массив
			 * @param {string[]} nestedKeys - массив ключей, содержащих вложенные массивы (по умолчанию ['level2', 'level3'])
			 * @param {string} valueKey - ключ, значения которого нужно собрать (по умолчанию 'value')
			 * @returns {Array} - плоский массив значений
			 */
			let arr = [
				{
					id: 1,
					name: "Объект 1 уровня 1",
					level2: [
						{
							id: 11,
							name: "Объект 1 уровня 2",
							level3: [
								{
									id: 111,
									name: "Объект 1 уровня 3",
									value: "Данные 1",
								},
								{
									id: 112,
									name: "Объект 2 уровня 3",
									value: "Данные 2",
								},
							],
						},
						{
							id: 12,
							name: "Объект 2 уровня 2",
							level3: [
								{
									id: 121,
									name: "Объект 3 уровня 3",
									value: "Данные 3",
								},
								{
									id: 122,
									name: "Объект 4 уровня 3",
									value: "Данные 4",
								},
							],
						},
				...
				{
					id: 2,
					name: "Объект 2 уровня 1",
					level2: [
						{
							id: 21,
							name: "Объект 3 уровня 2",
							level3: [
								{
									id: 211,
									name: "Объект 5 уровня 3",
									value: "Данные 5",
								},
								{
									id: 212,
									name: "Объект 6 уровня 3",
									value: "Данные 6",
								},
							],
						},
						{
							id: 22,
							name: "Объект 4 уровня 2",
							level3: [
								{
									id: 221,
									name: "Объект 7 уровня 3",
									value: "Данные 7",
								},
								{
									id: 222,
									name: "Объект 8 уровня 3",
									value: "Данные 8",
								},
							],
						},
				...
				{
					id: 3,
					name: "Объект 3 уровня 1",
					level2: [
						{
							id: 31,
							name: "Объект 5 уровня 2",
							level3: [
								{
									id: 311,
									name: "Объект 9 уровня 3",
									value: "Данные 9",
								},
								{
									id: 312,
									name: "Объект 10 уровня 3",
									value: "Данные 10",
								},
							],
						},
						{
							id: 32,
							name: "Объект 6 уровня 2",
							level3: [
								{
									id: 321,
									name: "Объект 11 уровня 3",
									value: "Данные 11",
								},
								{
									id: 322,
									name: "Объект 12 уровня 3",
									value: "Данные 12",
								},
							],
						},
			...
			function fromObjectArray(data, nestedKeys = ["level2", "level3"], valueKey = "value") {
				const result = [];

				function traverse(items) {
					for (const item of items) {
						// Рекурсивно обходим все вложенные массивы
						for (const key of nestedKeys) {
							if (Array.isArray(item[key])) {
								traverse(item[key]);
							}
						}
						// Если есть искомое значение — добавляем
