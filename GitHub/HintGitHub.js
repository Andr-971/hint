...
// 🔳 ⁡⁢⁣⁣РАБОТА С УДАЛЁННЫМ РЕПОЗИТОРИЕМ (GitHub)⁡
{
	// 🔹 ⁡⁣⁢⁡⁣⁢⁢Работа с CLI GitHub (Шпаргалка)⁡
	{
		...
		// 🌿 ⁡⁢⁢⁢Ветки и пул-реквесты (PR)⁡
		{
			// ⁡⁣⁣⁢# Создать PR из текущей ветки⁡
			// gh pr create
			// ⁡⁣⁣⁢# Просмотреть открытые PR⁡
			// gh pr list
			// ⁡⁣⁣⁢# Просмотреть конкретный PR⁡
			// gh pr view [<number> | <url>]
			// ⁡⁣⁣⁢# Локально проверить (checkout) PR⁡
			// gh pr checkout <number>
			// ⁡⁣⁣⁢# Обновить статус PR, комментировать, мержить и т.д⁡.
			// gh pr merge <number>
			// gh pr comment <number> --body "Отличная работа!"
		}
		// 📝 ⁡⁢⁢⁡⁢⁢⁢Issues (Проблемы)⁡
		{
			// ⁡⁣⁣⁢# Создать issue⁡
		...
		// 🔔 ⁡⁢⁢⁢Уведомления⁡
		{
			...
			// gh notification mark-read --all
		}
		// ⚙️ ⁡⁢⁢⁢Прочее⁡
		{
			// ⁡⁣⁣⁢# Открыть репозиторий в браузере⁡
			// gh repo view --web
			// ⁡⁣⁣⁢# Открыть текущий PR или issue в браузере⁡
			// gh pr view --web
			// gh issue view --web
			// ⁡⁣⁣⁢# Настройки⁡
			// gh config set editor "code -w"  # например, VS Code
		}
	}
